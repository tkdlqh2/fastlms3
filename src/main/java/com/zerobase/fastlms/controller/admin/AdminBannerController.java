...
public class AdminBannerController extends BaseController {
    ...
    public String list(Model model, BannerParam parameter) {
        parameter.init();
        List<BannerDto> list = bannerService.listAll(parameter);
        long totalCount = 0;
    ...
    public String addSubmit(Model model, HttpServletRequest request
        ...
        if (file != null) {
            ...
            String baseLocalPath = "D:/backendSchool/프로젝트/fastlms3/files";
        ...
        parameter.setOriginalImageName(saveFilename);
